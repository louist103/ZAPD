...
{
	if (buildMode == "me1")
		fileMode = ExporterFileMode::ModeExample1;
...
static bool ExporterProcessFileMode(ZFileMode fileMode)
{
	...
	if (fileMode == ExporterFileMode::ModeExample1)
		return true;
	else if (fileMode == ExporterFileMode::ModeExample2)
		return true;
	else if (fileMode == ExporterFileMode::ModeExample3)
		return true;
